...
public class JDBCContract {
	...
	private static final String POSTGRES_CONNECTION_URL = "jdbc:postgresql://localhost:5432/SDS_DB";
	private static final String POSTGRES_CONNECTION_URL_PREPARED = "jdbc:postgresql://localhost:5432/SDS_DB?prepareThreshold=3";
